@echo off
chcp 65001 >nul 2>&1
REM Metro-PIDS Cloudflare One-Click Deployment Script (Windows)
REM Auto deploy Worker and Pages

echo ========================================
echo Metro-PIDS Cloudflare Deployment
echo ========================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PS_SCRIPT=%SCRIPT_DIR%deploy-cloudflare-oneclick.ps1"
