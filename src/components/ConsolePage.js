...
export default {
  ...
  template: `
    <div style="flex:1; display:flex; flex-direction:column; overflow:auto; background:var(--card); padding:24px 16px;">
      <!-- Header -->
      ...
      <div style="display:flex; flex-direction:column;">
          ...
          <div class="card" style="border-left: 6px solid #FF9F43; border-radius:12px; padding:16px; background:var(--bg); box-shadow:0 2px 12px rgba(0,0,0,0.05); margin-bottom:28px;">
        ...
        <div class="card" style="border-left: 6px solid #FF4757; border-radius:12px; padding:16px; background:var(--bg); box-shadow:0 2px 12px rgba(0,0,0,0.05); margin-bottom:28px;">
        ...
        <div class="card" style="border-left: 6px solid #5F27CD; border-radius:12px; padding:16px; background:var(--bg); box-shadow:0 2px 12px rgba(0,0,0,0.05); margin-bottom:28px;">
        ...
        <div class="card" style="border-left: 6px solid #9B59B6; border-radius:12px; padding:16px; background:var(--bg); box-shadow:0 2px 12px rgba(0,0,0,0.05); margin-bottom:28px;">
