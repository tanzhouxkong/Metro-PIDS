...
export default {
  ...
  template: `
    ...
    <div id="slidePanel" style="flex:1; display:flex; flex-direction:column; overflow:auto; background:var(--card);">
      ...
      <div v-if="uiState.activePanel === 'panel-1'" class="panel-body" style="padding:24px 16px;">
        ...
        <div style="display:flex; flex-direction:column; gap:20px;">
            ...
            <div class="card" style="border-left: 6px solid #FF9F43; border-radius:12px; padding:16px; background:var(--bg); box-shadow:0 2px 12px rgba(0,0,0,0.05);">
