    ...
    ">
      ...
      ">
        ...
        <div id="admin-app" style="flex:1; display:flex; margin-left:72px; overflow:hidden;">
            <!-- Show different pages based on activePanel -->
            <div v-if="uiState.activePanel === 'panel-1'" style="flex:1; display:flex; flex-direction:column; overflow:hidden;">
              <ConsolePage />
            </div>
            <div v-else-if="uiState.activePanel === 'panel-4'" style="flex:1; display:flex; flex-direction:column; overflow:hidden;">
              <SettingsPage />
            </div>
            <div v-else-if="uiState.activePanel" style="flex:1; display:flex; flex-direction:column; overflow:hidden;">
              <SlidePanel />
            </div>
